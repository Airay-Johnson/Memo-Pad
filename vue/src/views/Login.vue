  ...
  <div class="login-page">
    <div class="login-card">
      <div class="login-header">
        ...
        <div class="app-name">Memo Pad</div>
        <div class="app-slogan">智能笔记 · AI 驱动</div>
      </div>
...
onMounted(() => {
  ...
  if (pwd) { try { form.value.password = atob(pwd); remember.value = true } catch (e) {} }
})
...
.remember-row { display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; padding: 0 2px; }
.login-btn {
